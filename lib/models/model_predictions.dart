...
//
//     final modelPredictions = modelPredictionsFromJson(jsonString);

// import 'dart:convert';
// ModelPredictions modelPredictionsFromJson(String str) => ModelPredictions.fromJson(json.decode(str));
// String modelPredictionsToJson(ModelPredictions data) => json.encode(data.toJson());
...
class ModelPredictions {
  ...
  factory ModelPredictions.fromJson(Map<String, dynamic> json) => ModelPredictions(
